function draw_cuadrado() {
  ...
  function draw_curvas_Bézier() {
    const canvas = document.getElementById("canvas_curvas_Bézier");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_curvas_cúbicas_Bézier() {
    const canvas = document.getElementById("canvas_curvas_cúbicas_Bézier");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
  ...
  function draw_rect() {
    const canvas = document.getElementById("canvas_rect");
    if (canvas.getContext) {
      const ctx = canvas.getContext("2d");
